...
(function () {
  ...
  // Header shadow + hero parallax — one scroll handler, single layout read
  var header = document.querySelector('.site-header');
  var heroImg = document.querySelector('.hero-image');
  if (header || heroImg) {
    var scrollTicking = false;
    var updateScroll = function () {
      var y = window.scrollY;                 // read layout once, before any write
  ...
  function initFunnel(form) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      fetch(form.getAttribute('data-endpoint'), {
        ...
        status.innerHTML = en
          ? 'Something went wrong. Please call us directly: <a href="tel:+4926512822">+49&nbsp;2651&nbsp;2822</a>.'
          : 'Leider ist etwas schiefgelaufen. Bitte rufen Sie uns direkt an: <a href="tel:+4926512822">02651&nbsp;2822</a>.';
      });
    });
